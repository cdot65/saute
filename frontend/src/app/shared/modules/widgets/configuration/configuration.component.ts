...
export class AutomationConfigurationComponent {
  configurationData = [
    ...
    },
    {
      ...
      description: "Create a new address group object on Panorama appliances.",
      buttonLink: "/deploy",
      hashtags: ["#panos", "#python"],
    },
    {
    ...
    },
    {
      ...
      description: "Use Python to create a new security rule on Prisma Access.",
      buttonLink: "/deploy",
      hashtags: ["#prisma", "#python"],
    },
    {
    ...
    {
      imagePath: "../../../../../assets/img/brand/python-panos-prisma.svg",
